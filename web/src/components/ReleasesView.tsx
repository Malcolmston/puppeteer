...
// the GitHub Releases API for malcolmston/puppeteer.
const RELEASE_LIBS: RelLib[] = [
  { name: PUPPETEER.name, icon: PUPPETEER.icon, accent: PUPPETEER.accent, repo: ghrepo(PUPPETEER), url: PUPPETEER.repo },
];
